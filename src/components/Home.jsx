  ...
  return (
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col items-start justify-start gap-4">
        ...
        <p className="text-textColor text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et, magnam, tempore recusandae delectus quidem natus sequi eveniet ipsa, excepturi dolore labore laboriosam dolorum doloribus? Obcaecati vitae sed quos! Commodi, minus.</p>
         ...
         <div className="w-full md:w-460 ml=0 flex  flex-wrap items-center justify-center gap-4 gap-y-14">
            {randomData && randomData.map((data,i) => (
                ...
                className="w-12 h-12 md:w-32 md:h-32 md:-mt-16 object-contain"
                 ...
                 <p className="text-sm ld:text-xl font-semibold text-textColor">
