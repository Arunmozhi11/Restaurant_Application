...
const DBHeader = () => {
  ...
  return (
    <div className="w-full flex items-center justify-between gap-3">
      ...
      <div className="flex items-center justify-center ga-4">
        <div className="flex items-center justify-center gap-3 px-4 py-2 bg-lightOverlay backdrop-blur-md rounded-md shadow-md">
          ...
          <input
            ...
            className="border-none outline-none bg-transparent text-base font-semibold text-textColor w-32"
          />
          <BsToggles2 className="text-gray-400 text-2xl" />
        </div>
        <motion.div
          {...buttonClick}
          className="w-10 h-10 rounded-md cursor-pointe bg-lightOverlay backdrop-blur-md shadow-sm flex items-center justify-center"
        >
