...
const DBNewItem = () => {
  ...
  return (
    <div className="flex item-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center gap-4">
        <InputValueField
          type="text"
        ...
        <div className="w-full flex item-center justify-around gap-3 flex-wrap">
          {statuses &&
            statuses?.map((data) => (
              <p
                key={data.id}
          ...
          {isLoading ? (
            <div className="w-full h-full flex flex-col items-center justify-evenly px-24">
              ...
              {Math.round(progress > 0) && (
                <div className="w-full flex flex-col item-center justify-center gap-2">
            ...
            <>
              {!imageDownloadURL ? (
                <>
                  <label>
                    <div className="flex flex-col item-center justify-center h-full w-full cursor-pointer">
